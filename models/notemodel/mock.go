...
type Mock struct {
	...
	ModStatusHandler func(ctx context.Context, id int, status Status) (err error)
...
func (m Mock) ModStatus(ctx context.Context, id int, status Status) (err error) {
	return m.ModStatusHandler(ctx, id, status)
}
